...
Movida para `../CLAUDE.md` (raiz de `app .STL`), porque as referências ali
— Remotion, Postiz, Firecrawl, Browser-use, CrewAI, AnythingLLM — não são
específicas do PubliProva e ficavam invisíveis fora desta pasta.
